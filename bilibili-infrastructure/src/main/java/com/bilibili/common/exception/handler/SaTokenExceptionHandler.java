...
public class SaTokenExceptionHandler {
    ...
    public Response handlerSaTokenException(SaTokenException e) {
        ...
        // 根据不同异常细分状态码返回不同的提示
        if (e.getCode() == 11001) {
            return Response.buildFailure("B_saTokenNotExit_11001", "未能读取到有效 Token");
        } else if (e.getCode() == 11011) {
            return Response.buildFailure("B_saTokenNotExit_11011", "用户未登录");
            ...
            return Response.buildFailure("B_saTokenPermissionDenied_500", "权限不足");
        }
        // 更多 code 码判断 ...

        // 默认的提示
        return Response.buildFailure("B_saTokenUnknowError_500", "服务器繁忙，请稍后重试...");
    }
}
